...
const BasicPageTemplate = ({ pageData: { title, body }, servicesData }) => (
  <>
            ...
            <Content className="item-content">
              <div className="entry-content">
                ...
                <p>
                  ...
                  mignon sirloin tail sausage capicola venison short loin brisket pancetta pork chop. Ham hock andouille
                  strip steak chuck turducken cow. Ham hock porchetta pastrami flank, tongue jerky pork belly leberkas.
                </p>
                <p>
                ...
                <blockquote className="text-center">
                  ...
                  reschedule, I call ClearView not only they help me the same day, in and out of there shop in lest then
                  1hr, excellent services, and most important, price.»
                ...
                <p>
                  Leberkas venison sirloin andouille, drumstick filet mignon boudin hamburger pastrami pork chop ribeye
                  bresaola ball tip. Alcatra turducken flank sirloin beef t-bone venison ball tip cow. Porchetta kevin
                  hamburger chuck. Porchetta doner drumstick, short ribs ham hock short loin salami filet mignon jowl
                  pork chop swine bresaola cow picanha. Jowl venison swine corned beef.
                </p>
                ...
                <p>
                  ...
                  brisket ball tip capicola strip steak t-bone bresaola landjaeger ribeye. Bresaola pork belly ball tip
                  spare ribs flank kielbasa drumstick porchetta turkey pork loin doner sausage.
                </p>
                <p>
                  Frankfurter tail tongue drumstick andouille short ribs turkey ham hock meatball short loin salami
                  turducken rump jerky bresaola. Tri-tip pastrami short loin pork belly jowl andouille brisket sausage.
                </p>
                <p>
                  Swine jerky pork chop pork loin capicola. Tail filet mignon meatloaf pig turkey, boudin jerky biltong
                  sausage chuck picanha ham hock. Bacon meatloaf short ribs.
                </p>
                <p>
